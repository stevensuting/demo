...
$(function () {
    ...
    $('#add').click(function () {
        Highcharts.charts[0].series[0].setData([14.5, 18.2, 1.5, 5.2, 26.5, 23.3, 18.3, 13.9],true);
    });

    $('#add1').click(function () {
        Highcharts.charts[0].series[0].setData([7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6],true);
    });

    $('#add2').click(function () {
        Highcharts.charts[0].series[0].setData([7.0, 9.5, 18.2, 21.5,  26.5, 23.3, 13.9, 9.6],true);
